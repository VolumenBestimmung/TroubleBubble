# Aus:
# https://github.com/mabhisharma/Multi-Object-Tracking-with-Kalman-Filter vom 20.06.2021
# Der Urheber (mabhisharma) stellt es allen Interessierten ohne Kosten frei zur Verfügung, siehe:
# https://github.com/mabhisharma/Multi-Object-Tracking-with-Kalman-Filter/blob/master/LICENSE
# Veränderungen durch J.Kerpe:
...
class Tracks(object):
    ...
    def __init__(self, detection, trackId):
        ...
        self.isOut = False  # von J.Kerpe hinzugefügt; Boolean, ob Blasen schon aus Bild draußen ist
        self.volume = []    # von J.Kerpe hinzugefügt;
